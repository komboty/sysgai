...
public final class Constantes {
    ...
    public static final double VISTA_STAGE_ALTO = 800;
    public static final double VISTA_STAGE_ANCHO = 1000;
...
//    public static final String VISTA_URL_USUARIOS = "/pantallas/usuarios/usuariosVista.fxml";
    ...
    public static final String VISTA_URL_DETALLE_INFO = "/pantallas/utils/detalleInfo.fxml";
    public static final String VISTA_URL_TABLA = "/pantallas/utils/tabla.fxml";
